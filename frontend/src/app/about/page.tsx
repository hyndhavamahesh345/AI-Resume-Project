      ...
      <section className="min-h-screen bg-primary grid grid-cols-1 lg:grid-cols-2 relative overflow-hidden">
        <div className="flex flex-col justify-center py-24 px-12 lg:pl-16">
          ...
          <p className="font-sans text-sm font-light leading-[1.8] text-text-muted max-w-[440px] mb-10">
            Upload a resume and job description. Get an ATS-optimized resume, a live deployed project, and recruiter-ready outreach copy — in under 2 minutes.
          </p>
      ...
      <section id="how-it-works" className="bg-primary py-24 px-8 lg:px-16 border-t border-border">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="flex flex-col">
            {[
              { num: "01", title: "JD Analysis", desc: "AI extracts required skills, exact keywords, and tech stack from the job description using structured output.", isMuted: false },
              { num: "02", title: "Code Generation", desc: "The project generator creates a complete, role-specific interactive project — not boilerplate. Architecturally relevant to the exact role.", isMuted: false },
              { num: "03", title: "Auto-Deploy", desc: "Vercel Deploy API deploys the project to a unique public URL in seconds. No manual steps. No GitHub required.", isMuted: false },
              { num: "04", title: "Resume Reconstruction", desc: "Every section rewritten in JD language. Live project URL embedded as primary portfolio item. Downloadable as ATS-clean PDF.", isMuted: false },
              { num: "05", title: "Outreach Copy", desc: "Cover letter + recruiter message, both referencing the live project URL as proof of capability.", isMuted: true },
            ].map((step, idx) => (
      ...
      <section className="bg-secondary py-24 px-8 lg:px-16 border-t border-border">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            ...
            <div>
              <p className="font-sans text-[9px] font-medium tracking-[0.25em] text-text-muted uppercase mb-6">
                After Resume Project
              </p>
              {[
                "Resume rebuilt in JD's exact language — passes ATS keyword matching",
                "Live deployed project proves technical capability with a working URL",
                "Recruiter message under 300 characters, includes project link"
              ].map((text, i) => (
                <div key={i} className="flex gap-3 mb-4">
